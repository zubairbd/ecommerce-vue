								...
								<div class="card mb-5 mb-xl-8">
									...
									<div class="card-header border-0 pt-5">
										<h3 class="card-title align-items-start flex-column">
											<span class="card-label fw-bolder fs-3 mb-1">Category Manage</span>
											<span class="text-muted mt-1 fw-bold fs-7">Over {{amar}} categories</span>
										</h3>
										<div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add a user">
											<router-link :to="{name:'category-add'}" class="btn btn-sm btn-light btn-active-primary">
											...
											<table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
												...
												<tbody>
													<tr v-for="(row, key) in data" :key="key">
														...
														<td>
															<span class="text-dark fw-bolder text-hover-primary d-block fs-6">{{ row.category_name }}</span>
														</td>
														<td>
															<span class="text-dark fw-bolder text-hover-primary d-block fs-6">{{ row.category_slug }}</span>
														</td>
														<td>
															<span class="badge" :class="statusColor(row.status)">{{statusName(row.status)}}</span>
														</td>
														<td>
